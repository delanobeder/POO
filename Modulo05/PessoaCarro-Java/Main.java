...
public class Main {
    ...
    public static void main(String args[]) {
        ...
        System.out.println(p1.adicionaCarro(c1));
        System.out.println(p1.adicionaCarro(c2));
        System.out.println(p1.adicionaCarro(c3));
        System.out.println(p1.adicionaCarro(c4));

        // Construtor que seta os valores de todos os atributos
        Pessoa p2 = new Pessoa("Fulano", "012345678-90");
        System.out.println(p2.adicionaCarro(c4));
